  ...
  const problemStatements = [
    {
      ...
      content: (
        <>
          <p className="font-bold mb-2 md:mb-3 text-sm md:text-base">Challenge:</p>
          ...
          <p className="font-bold mb-2 md:mb-3 text-sm md:text-base">Key Features to Implement:</p>
          ...
          <p className="font-bold mb-2 md:mb-3 text-sm md:text-base">Expected Outcome:</p>
  ...
  return (
    <div className="container mx-auto px-4 py-6 md:py-8 lg:py-12">
      <div className="max-w-6xl mx-auto">
        <h4 className="text-2xl md:text-3xl lg:text-4xl font-bold text-[#5A2A25] mb-6 md:mb-8">Problem Statements</h4>

        {/* Mobile Dropdown*/}
        <div className="mb-6 md:hidden">
          <label htmlFor="problem-select" className="block text-sm font-medium text-[#5A2A25] mb-2">
